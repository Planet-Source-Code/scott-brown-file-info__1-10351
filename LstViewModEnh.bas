Attribute VB_Name = "LstViewModEnh"
    
'Respect to: John Allan Lee for the enhancements to the ListView control used here
...
' Type: Public Function
' Description: Use on ColumnClick to sort by that Column  Toggles between Ascending and Descending Sorts
'
...
' Type: Public Function
' Description: Resizes the ColumnHeaders in a ListView to the Width  of the ListView
'
...
' Type: Long
' Description: Used to set the length in twips per character for column spacing  Defaults to 80 if not specified
...
Public Declare Function ShellExecute Lib "shell32.dll" Alias "ShellExecuteA" (ByVal hWnd As Long, ByVal lpOperation As _
